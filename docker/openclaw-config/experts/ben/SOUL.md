...
You CAN still use `consult_expert` for quick factual lookups during your work — e.g., asking Ron for a function signature, or Ann for a metric formula. Keep these to specific, bounded questions (not "help me answer this user's question").
